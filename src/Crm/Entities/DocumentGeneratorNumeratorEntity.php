...
/**
 * Class DocumentGeneratorNumeratorEntityEntity
 ...
 */
class DocumentGeneratorNumeratorEntityEntity extends EntityAbstract
{
    const ENTITY_NAME = 'documentgenerator.numerator';
